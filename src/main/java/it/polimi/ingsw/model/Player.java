...
public class Player {
    ...
    public boolean checkForDiscountLeader(int leader) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (allCardsColor[i][j] == leaderPointer.getColor2DiscountCard() && allCardsColor[i][j] != null)
                    conditions[0] = true;
                if (allCardsColor[i][j] == leaderPointer.getColor1DiscountCard() && allCardsColor[i][j] != null)
                    conditions[1] = true;
            }
        }
    ...
    public boolean checkForWhiteBallLeader(int leader) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (conditions[0] && allCardsColor[i][j] == leaderPointer.getColor1WhiteBallCard() && allCardsColor[i][j] != null)
                    conditions[1] = true;
                if (allCardsColor[i][j] == leaderPointer.getColor1WhiteBallCard() && allCardsColor[i][j] != null)
                    conditions[0] = true;
                if (allCardsColor[i][j] == leaderPointer.getColor2WhiteBallCard() && allCardsColor[i][j] != null)
                    conditions[2] = true;
            }
        }
    ...
    public boolean checkForProductionLeader(int leader) {
        ...
        for (int i = 0; i < 3; i++) {
            allCardsColor[i] = board.getSlot(i + 1).get_colors();
            if (allCardsColor[i][1] == leaderPointer.getColorProductionCard() && allCardsColor[i][1] != null)
                condition = true;
        }
        return condition;
    }
    ...
    public boolean checkForStorageLeader(int leader) {
        ...
        if (leaderPointer.getStorageCardCost() != null) {
            return board.getTotalResources()[StaticMethods.TypeOfResourceToInt(leaderPointer.getStorageCardCost())] > 4;
        }
        return false;
    }
    ...
    public boolean[] doIHaveAWhiteBallLeader() {
        ...
        for (int i = 1; i < 3; i++) {
            if (switchLeader(i).checkIfPlayed() && switchLeader(i).getColor1WhiteBallCard() != null)
                leaders[i - 1] = true;
        }
        return leaders;
    }
    ...
    public boolean[] doIHaveADiscountLeader() {
        boolean[] leaders = new boolean[2];
        for (int i = 1; i < 3; i++) {
            if (switchLeader(i) != null && switchLeader(i).checkIfPlayed() && switchLeader(i).getColor1DiscountCard() != null)
                leaders[i - 1] = true;
        }
        return leaders;
    }
    ...
    public boolean[] doIHaveAProductionLeader() {
        boolean[] leaders = new boolean[2];
        for (int i = 1; i < 3; i++) {
            if (switchLeader(i) != null && switchLeader(i).checkIfPlayed() && switchLeader(i).getColorProductionCard() != null)
                leaders[i - 1] = true;
        }
        return leaders;
    }
    ...
    public boolean hasPlayerFinished() {
        ...
        return board.getFaithTrack().getFaithMarker() == 24;
    }
