...
public class CliForSP {
    ...
    public static int[] playOrDiscardLeader(GameStatusUpdate status, boolean isDiscarded1, boolean isDiscarded2) {
        ...
        int[] selection = new int[2];
        if (status.getPlayersStatus()[0].isFirstLeaderPlayed() || status.getPlayersStatus()[0].isSecondLeaderPlayed())
            System.out.println("You have already played these leaders:");
    ...
    public static int selectACardFromMarket(GameStatusUpdate status) {
        ...
        do {
            if (!nextphase)
                System.out.println("now please type the id of the card you want to buy, or 0 if you want to exit: ");
